...
apk --arch x86_64 -X http://dl-cdn.alpinelinux.org/alpine/latest-stable/main/ -U --allow-untrusted --root ${ROOTDIR} --initdb add alpine-base openssh ethtool net-tools
