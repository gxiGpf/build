...
apk --arch x86_64 -X http://dl-cdn.alpinelinux.org/alpine/edge/main/ -U --allow-untrusted --root ${ROOTDIR} --initdb add alpine-base openssh ethtool net-tools mbedtls ruby fuse3 sshpass rsync curl linux-lts
apk --arch x86_64 -X http://dl-cdn.alpinelinux.org/alpine/edge/community -U --allow-untrusted --root ${ROOTDIR} --initdb add fuse
apk --arch x86_64 -X http://dl-cdn.alpinelinux.org/alpine/edge/testing -U --allow-untrusted --root ${ROOTDIR} --initdb add dislocker
